                                ...
                                <div className='detallesProductos-detalle-pr8'>
                                    <div className='detallesProductos-columnas-pr8'>
                                        <div className='detallesProductos-columnas-pr8-textos'>
                                            ...
                                            <br/>
                                            <b><p style={{fontSize:"1.3rem",color:"goldenrod"}}>Calificación: {product.rating.rate} ({product.rating.count} votos)</p></b>
                                            <br />
                                            <b><p style={{fontSize:"1.8rem"}}>Precio: ${product.price}</p></b>
                                        </div>

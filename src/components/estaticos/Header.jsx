...
function Header({cartItems, borrarProducto, vaciarCarrito}) {
        ...
        <nav>
            <ul>
                ...
                <li>
                    ...
                    <Cart borrarProducto={borrarProducto} cartItems={cartItems} isCartOpen={isCartOpen} onClose={()=>setIsCartOpen(false)} vaciarCarrito={vaciarCarrito}/>
                </li>
            </ul>
        </nav>
    </header>
